...
public class NearStations extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		sv.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> p1, View p2, int p3, long p4)
				{
					...
					//Toast.makeText(NearStations.this,stationId+"-"+rarr.size(),Toast.LENGTH_LONG).show();
					...
					//new CAlertDialog(NearStations.this,st.name,ssb.toString(),"OK",false,CAlertDialog.ACTION_HIDE_DIALOG);
					new CAlertDialog(NearStations.this,s,"",st,rarr,"OK",false,null);
		...
		sv.setOnItemLongClickListener(new OnItemLongClickListener(){
				...
				public boolean onItemLongClick(AdapterView<?> p1, View p2, int p3, long p4){
					...
					new CAlertDialog(NearStations.this,s.name,inf,"OK",false,CAlertDialog.ACTION_HIDE_DIALOG);
					return true;
				}
